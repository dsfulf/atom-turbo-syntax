...
module.exports =
  ...
  activate: (state) ->
    atom.commands.add 'atom-text-editor',
      'turbo-brackets:end-line': => @endLine(';', false)
    atom.commands.add 'atom-text-editor',
      'turbo-brackets:end-line-comma': => @endLine(',', false)
    atom.commands.add 'atom-text-editor',
      'turbo-brackets:c-wrap-block': => @wrapBlock('{')
    atom.commands.add 'atom-text-editor',
      'turbo-brackets:s-wrap-block': => @wrapBlock('[')
